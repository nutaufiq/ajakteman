...
@section('title', 'User - Edit - Webcontrol')
...
@section('content')
  ...
  <form role="form" method="POST" action="{{ url('webcontrol/user/'.$user->id.'/edit') }}" id="form-login">
    {{ csrf_field() }}
    <div class="row">
      <div class="col-md-9">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="email" name="email" placeholder="Email" value="{{ old('email', $user->email) }}" readonly="readonly">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="olx_id" name="olx_id" placeholder="OLX ID" value="{{ old('olx_id', $user->olx_id) }}">
          @if ($errors->has('olx_id')) <p class="text-danger">{{ $errors->first('olx_id') }}</p> @endif
        </div>

        <div class="form-group">
          <label for="referrer_olx_id">Referrer [OLX ID]</label>
          <input type="text" class="form-control" id="referrer_olx_id" name="referrer_olx_id" placeholder="Referrer [OLX ID]" value="{{ old('referrer_olx_id', $user->referrer_olx_id) }}">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="invite_id" name="invite_id" placeholder="Referrer [OLX ID]" value="{{ old('invite_id', $user->invite_id) }}">
      ...
      <div class="col-md-3 box">
        ...
        <div class="form-group">
          ...
          <div class="radio">
            <label>
              <input type="radio" name="is_verified" id="radio" value="1" {{ old('is_verified', $user->is_verified) == 1 ? 'checked="checked"' : '' }}>
              Yes
            </label>
          </div>
          <div class="radio">
            <label>
              <input type="radio" name="is_verified" id="radio" value="0" {{ old('is_verified', $user->is_verified) == 0 ? 'checked="checked"' : '' }}>
              No
            </label>
          </div>
