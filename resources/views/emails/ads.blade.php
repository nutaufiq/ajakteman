        ...
        <body style="font-family: 'normaldin', sans-serif; ">
            ...
            <table style="width:100%; max-width:600px; background-color: #FFFFFF;" border="0" cellpadding="0" cellspacing="0">
                <tr><td style="text-align: center; padding: 30px 0px; background-color: #FFFFFF;">
                    <center><a href="{{ url('login') }}"><img src="{{ asset('images/logo.png') }}" style="display: block; max-width: 150px;"></a></center>
                </td></tr>                
                ...
                <tr><td style="background-color:#FFFFFF; padding:15px; color:#333333; font-size: 16px; line-height:25px; text-align:center;">
                    Jangan lupa untuk pasang iklan-mu untuk mendapatkan Saldo OLX
                </td></tr>                
                <tr><td style="padding:20px 0px 30px; background-color:#FFFFFF; text-align:center;">
                    <a href="{{ url('dashboard/pasang-iklan/form') }}" style="padding:15px 20px; border:1px solid #999999; color:#FFFFFF; text-decoration:none; font-weight:bold; background-color:#651784">PASANG IKLAN</a>
                </td></tr>                
